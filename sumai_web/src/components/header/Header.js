  ...
  const Logo = (
    <a href='/' className={classes.link}>
      <img
        src={imgLogo}
        alt='SUMAI'
        className={matches ? classes.imgLogo : classes.imgLogoMob}
      />
      <Typography
  ...
  return (
    <div className={classes.root}>
      <AppBar
        ...
        style={matches ? { padding: '10px 0px' } : { minWidth: '250px' }}>
        <Toolbar
          variant='dense'
          style={matches ? {} : { padding: '0px 10px 0px 20px', flex: 1 }}>
          <LeftDrawer
            classes={classes}
