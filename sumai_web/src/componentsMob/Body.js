  ...
  render() {
    ...
    return (
      <Box className={classes.root}>
        <Box
          style={{ boxShadow: '#e0e0e0 0px 3px 3px -2px, #e0e0e0 0px 2px 4px 0px, rgba(0, 0, 0, 0.12) 0px 1px 0px 0px' }}
          ...
          <Box display='flex' style={{ padding: 16, background: '#fff' }}>
            <Box width='100%'>
              <TextareaAutosize
                ...
                onBlur={(e) => (e.target.placeholder = '요약할 내용을 입력하세요.')}
              />
            </Box>
